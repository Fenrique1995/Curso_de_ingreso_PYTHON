...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert(message="El resultado de la suma es: "+str(suma))

    def btn_restar_on_click(self):
        resta = int(self.txt_operador_a.get())-int(self.txt_operador_b.get())
        alert(message="El resultado de la resta es: "+str(resta))

    def btn_multiplicar_on_click(self):
        multiplicar = int(self.txt_operador_a.get())*int(self.txt_operador_b.get())
        alert(message="El resultado de la multiplicacion es: "+str(multiplicar))

    def btn_dividir_on_click(self):
        dividir = int(self.txt_operador_a.get())/int(self.txt_operador_b.get())
        alert(message="El resultado de la division es: "+str(dividir))
